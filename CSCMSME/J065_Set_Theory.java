...
public class J065_Set_Theory {
        public static void main(String[] args) {
                ...
                set12.print();
                System.out.println(
                                "Is Set12 equivalent to Empty Set ? ==> " + (set12.equals(new Set()) ? "Yes" : "No"));
                System.out.println("Is Set12 equivalent to Empty Set ? ==> "
                                + (set12.equals(new Set(new int[] {})) ? "Yes" : "No"));
                ...
                System.out.println(
                                "Do {1, 2, 5, 98} belong to Set 10 ? ==> " + (set13.belongsTo(set10) ? "Yes" : "No"));
                System.out.println("");

                System.out.println("Set 14");
                System.out.println("===========");
                System.out.println("Empty Set U {2,5,6,7} ==> "
                                + new Set().union(new Set(new int[] { 2, 5, 6, 7 })).getStringValue());
                System.out.println("{2,5,6,7} U Empty Set ==> "
                                + new Set(new int[] { 2, 5, 6, 7 }).union(new Set()).getStringValue());
                System.out.println("");

                System.out.println("Set 15");
                System.out.println("===========");
                System.out.println("{} - {2,5,6,7} ==> "
                                + new Set().differ(new Set(new int[] { 2, 5, 6, 7 })).getStringValue());
                System.out.println("{2,5,6,7} - {} ==> "
                                + new Set(new int[] { 2, 5, 6, 7 }).differ(new Set()).getStringValue());
                System.out.println("");
                ...
                System.out.println("===========");
                Set set18 = new Set(new double[] { Math.log(10), Math.pow(2.5, 2.5), Math.cos(14), Math.PI,
                                Math.asin(0.5), Math.tan(20) });
                set18.print();
                System.out.println("");

...
public class J065_Set_Theory {
    public static void main(String[] args) {
        ...
        set11.print();
        System.out.println("Is Set11 equivalent to Set1 ? ==> " + (set11.equals(set1)
                ? "Yes"
                : "No"));
        System.out.println("Is Set11 equivalent to Set2 ? ==> " + (set11.equals(set2)
                ? "Yes"
                : "No"));
        System.out.println("Is Set11 equivalent to Set3 ? ==> " + (set11.equals(set3)
                ? "Yes"
                : "No"));
        System.out.println("Is Set11 equivalent to Set4 ? ==> " + (set11.equals(set4)
                ? "Yes"
                : "No"));
        System.out.println("");
        ...
        set12.print();
        System.out.println("Is Set12 equivalent to Empty Set ? ==> " +
                (set12.equals(new Set()) ? "Yes" : "No"));
        System.out.println(
                "Is Set12 equivalent to Empty Set ? ==> " + (set12.equals(new Set(new int[] {})) ? "Yes" : "No"));
        System.out.println("Is Set12 equivalent to Empty Set ? ==> " +
                (set12.equals(set1) ? "Yes" : "No"));
        System.out.println("");
        ...
        set13.print();
        System.out.println("Do {5, 6, 7} belong to Set 10 ? ==> " +
                (set13.belongsTo(set10) ? "Yes" : "No"));
        set13 = new Set(new int[] { 5, 7, 8 });
        System.out.println("Do {5, 7, 8} belong to Set 10 ? ==> " +
                (set13.belongsTo(set10) ? "Yes" : "No"));
        set13 = new Set(new int[] { 1, 2, 5, 98 });
        System.out.println("Do {1, 2, 5, 98} belong to Set 10 ? ==> " +
                (set13.belongsTo(set10) ? "Yes" : "No"));
        System.out.println("");
        ...
        System.out.println("===========");
        System.out.println(
                "Empty Set U {2,5,6,7} ==> " + new Set().union(new Set(new int[] { 2, 5, 6, 7
                })).getStringValue());
        System.out.println(
        ...
        System.out.println("===========");
        System.out
                .println("{} - {2,5,6,7} ==> " + new Set().differ(new Set(new int[] { 2, 5,
                        6, 7 })).getStringValue());
        System.out
